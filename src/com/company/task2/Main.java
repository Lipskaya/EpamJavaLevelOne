...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    student9.setGroup(1);
    universityStydents[9] = student10;
  ...
  //список студентов заданного факультета;
  public static List<Student> listOfStudentsInFaculty(String faculty, Student[] students) {
  ...
  public static List<Student> listFacultyAndCourse(String faculty, int course, Student[] students) {
    List rezalt = new ArrayList();
    for (int i = 0; i < students.length; i++) {
      Student s = students[i];
  ...
  public static Set<String> listFaculties(Student[] students) {
    Set rezalt = new HashSet();
    for (int i = 0; i < students.length; i++) {
      Student s = students[i];

      rezalt.add(s.getFaculty());
  ...
  // список студентов, родившихся после заданного года;
  public static List<Student> listYearOfBirth(int year, Student[] students) {
    List rezalt = new ArrayList();
    for (int i = 0; i < students.length; i++) {
      Student s = students[i];
  ...
  //список учебной группы
  public static List<Student> listGroups(String facultet, int groups, Student[] students) {
    List rezalt = new ArrayList();
    for (int i = 0; i < students.length; i++) {
      Student s = students[i];
